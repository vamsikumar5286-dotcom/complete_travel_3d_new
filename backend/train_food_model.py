...
"""
train_food_model.py
Train XGBoost to predict Food_Cost.

Default usage:
python train_food_model.py --data synthetic_travel_dataset.csv --out food_model_pipeline.pkl
"""
import argparse
import sys
import pandas as pd
...
def build_and_train(df, out_path, random_state=42):
    ...
    # Fill categorical with a placeholder
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Food Cost XGBoost model")
    parser.add_argument("--data", type=str, default="synthetic_travel_dataset.csv", help="Path to CSV file")
    parser.add_argument("--out", type=str, default="food_model_pipeline.pkl", help="Output pipeline file")
